...
(function (root, factory) {
  ...
  var INDICATOR_GLOSSARY = [
    ...
    { term: "sr", read: "支持線・抵抗線（S/R）", def: "過去に価格が反発・頭打ちしやすかった水準を自動で抽出したもの。タッチ回数が多いほど意識されやすい目安にすぎない。／注: 直近の支持・抵抗は終値の上下で機械的に選ぶため、線のラベル（R×n/S×n）と呼称が入れ替わって見えることがあります（過去のタッチ位置で R/S を付けているため）。" },
